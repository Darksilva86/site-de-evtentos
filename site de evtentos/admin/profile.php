...
// Se não for admin, não deveria estar aqui, mas o profile é genérico.
// Porém, como está na pasta admin, vamos manter consistência.

$page_title = "Meu Perfil (Admin)";
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold"><i class="bi bi-person-circle"></i> Meu Perfil (Administrador)</h1>
        <a href="index.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Voltar ao Dashboard</a>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
            <div class="profile-sidebar">
                <div class="profile-avatar bg-primary text-white d-flex align-items-center justify-content-center rounded-circle mx-auto mb-3" style="width: 100px; height: 100px; font-size: 3rem;">
